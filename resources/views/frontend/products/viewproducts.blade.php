    ...
    <div class="py-3 mb-4 shadow-sm bg-warning border-top">
        <div class="container">
            <h6 class="mb-0">
                ...
                /
                <a href="{{ url('category/'.$products->category->name.'/'.$products->slug) }}">{{ $products->name }}</a></h6>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <hr>
                        <label class="me-3">Original price: <s>PKR {{ $products->original_price }}</s></label>
                        <label class="fw-bold">Selling price: PKR {{ $products->selling_price }}</label>
                        <hr>
                        @if ($products->qty > 0)
